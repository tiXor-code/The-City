...
namespace TheCity.ChessMaze
{
    public class MapVisualizer : MonoBehaviour
    {
        ...
        private Dictionary<Vector3, GameObject> dictionaryOfObstacles = new Dictionary<Vector3, GameObject>();
        ...
        public Direction GetDicrectionOfNextCell(Vector3 position, MapData data)
        {
        ...
        public Direction GetDirectionOfPreviousCell(Vector3 position, MapData data)
        {
        ...
        {
            var placementPosition = position + new Vector3(0, .5f, 0);
