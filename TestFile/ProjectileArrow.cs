...
namespace TheCity.TowerAI
{
    public class ProjectileArrow : MonoBehaviour
    {
        ...
        public static void Create(Vector3 spawnPosition, EnemyAI.Enemy enemy, int damageAmount)
        {            
            Transform arrowTransform = Instantiate(projectileArrow, spawnPosition, Quaternion.identity);
